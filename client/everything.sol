...
contract UserContract{
  ...
  function Initiate(uint _amounta, uint _amountb, uint _premium, bool _isLong) payable public {
    ...
    (address token_a_address, address token_b_address) = factory.getBase();
